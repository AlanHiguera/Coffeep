  ...
  <main>
    <div class="form-container">
      <div class="form-content">
        <h1>Registro</h1>
        <form name="Nuevo Usuario" method="POST" action="registrarse_admins.php">
          <div class="form-group">
            <label for="username">Nombre de usuario (admin + N° especificado en el correo)</label>
