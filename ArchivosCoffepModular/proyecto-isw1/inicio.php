        ...
        <?php if ($result->num_rows > 0): ?>
            <?php while ($row = $result->fetch_assoc()): ?>
                <div class="recipe-card">
                    ...
                    // Crea el formato de la imagen en base64
                    $imageSrc = 'data:image/jpeg;base64,' . $imageData;
                    ?>
                    <img src="<?php echo $imageSrc; ?>" alt="<?php echo htmlspecialchars($row['Rec_nombre']); ?>">
                    <h4><?php echo htmlspecialchars($row['Rec_nombre']); ?></h4>
                    <p class="rating">⭐ <?php echo htmlspecialchars($row['Rec_calificacion']); ?></p>
                    <span class="tag"><?php echo htmlspecialchars($row['Rec_clasificacion']); ?></span>
                    <p><?php echo htmlspecialchars($row['Rec_nickname']); ?></p>
                </div>
            <?php endwhile; ?>
        <?php else: ?>
