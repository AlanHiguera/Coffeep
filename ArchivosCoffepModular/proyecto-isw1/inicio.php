          ...
          <?php if ($result->num_rows > 0): ?>
              <?php while ($row = $result->fetch_assoc()): ?>
                  <div class="recipe-card">
                      <img src="<?php echo $row['Rec_foto']; ?>" alt="<?php echo $row['Rec_nombre']; ?>">
                      <h4><?php echo $row['Rec_nombre']; ?></h4>
                      <p class="rating">⭐ <?php echo $row['Rec_calificacion']; ?></p>
                      <span class="tag"><?php echo $row['Rec_clasificacion']; ?></span>
                  </div>
              <?php endwhile; ?>
          <?php else: ?>
