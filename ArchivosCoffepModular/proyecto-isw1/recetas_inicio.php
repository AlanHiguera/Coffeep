...
if ($isRankingChecked) {
    $sql = "SELECT Rec_nombre, Rec_foto, Rec_calificacion, Rec_clasificacion, Rec_nickname FROM Receta ORDER BY Rec_calificacion DESC LIMIT 10";
} else {
    $sql = "SELECT Rec_nombre, Rec_foto, Rec_calificacion, Rec_clasificacion, Rec_nickname FROM Receta";
}
